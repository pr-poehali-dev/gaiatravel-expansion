...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Изготовление мангала занимает от 7 до 10 дней в зависимости от загруженности производства. Стараемся выполнять заказы как можно быстрее, не теряя в качестве.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Конечно. Изготавливаем мангалы под любые размеры, с нужной вам высотой и шириной. А ещё делаем садовую мебель и качели в стилях лофт и брутал — подберём решение под ваш участок и вкус.",
  },
  {
  ...
  {
    question: "Как заказать мангал?",
    answer:
      "Оставьте заявку через форму на сайте, либо звоните по номеру +7 (928) 239-81-49 или пишите в Мах по этому же номеру — поможем выбрать модель и оформим доставку.",
  },
]
