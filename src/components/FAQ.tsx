...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Используем конструкционную сталь толщиной от 2 до 4 мм в зависимости от модели. Такая толщина не прогорает и служит долгие годы даже при частом использовании.",
  },
  {
