...
const expertiseAreas = [
  {
    ...
    description: "Используем сталь 3-5 мм — мангал служит десятилетиями и не деформируется от жара.",
    icon: "Flame",
  },
  {
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            Каждый мангал проходит контроль на производстве, прежде чем попасть к вам на дачу, в загородный дом или на базу отдыха. Работаем как с частными клиентами, так и с бизнесом.
          </p>
        </div>
